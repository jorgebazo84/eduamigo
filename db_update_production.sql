-- ==========================================================
-- EduAmigo: Script de Actualización Segura para MySQL Producción
-- ==========================================================
-- Este script es 100% seguro para bases de datos con datos existentes.
-- Crea las tablas que no existan y añade columnas necesarias sin alterar tus datos.
...
-- ==========================================================
-- ACTUALIZACIONES DE COLUMNAS (Para tablas que ya existían)
-- ==========================================================
...
-- Añadir columnas que puedan faltar en tablas existentes
CALL AddColumnIfMissing('rewards', 'userId', 'VARCHAR(64) DEFAULT NULL AFTER `id`');
CALL AddColumnIfMissing('calligraphy_sessions', 'parentId', 'VARCHAR(64) DEFAULT NULL AFTER `childId`');
CALL AddColumnIfMissing('history', 'duration', 'INT DEFAULT NULL');
CALL AddColumnIfMissing('history', 'sentiment', 'VARCHAR(50) DEFAULT NULL');
CALL AddColumnIfMissing('history', 'imageUrl', 'TEXT DEFAULT NULL');
CALL AddColumnIfMissing('history', 'audioUrl', 'TEXT DEFAULT NULL');
CALL AddColumnIfMissing('history', 'transcription', 'TEXT DEFAULT NULL');
CALL AddColumnIfMissing('exam_results', 'duration', 'INT DEFAULT NULL');
CALL AddColumnIfMissing('study_tasks', 'handwriting_image', 'TEXT DEFAULT NULL');
CALL AddColumnIfMissing('study_tasks', 'medical_evaluation', 'TEXT DEFAULT NULL');
